    ...
    <div class="wrapper">
      <div class="box">
        ...
        <div class="w-[920px] max-w-full mx-auto border-b border-b-white pb-8 mb-12 md:grid md:grid-cols-8 md:gap-x-6 lg:items-center">
          <!-- Logo -->
          <a href="<?= home_url() ?>" class="text-2xl leading-none font-bold uppercase duration-200 hover:text-blue-500  block text-center mb-12 md:col-span-2 md:col-start-4 md:mb-0">
            HappyWheels
          </a>
        </div>
      </div>
