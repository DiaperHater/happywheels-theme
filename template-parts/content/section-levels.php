    ...
    <div class="box">
      ...
      <div class="grid gap-y-24 gap-12 justify-items-center md:gap-24 md:grid-cols-2">
        ...
        print_level_card(
          3,
          '
            Наши курсы третьего уровня созданы для того, чтобы дать вам что-то новое для работы, будь то введение в артистическое катание, новые танцевальные движения или трюки и навыки, в которых используются техники среднего уровня. Вам нужно будет уметь кататься вперед, назад, поворачиваться и останавливаться.
            <br>
            <br>Подходит для:
