		...
		<div class="box">
			...
			<div class="grid grid-cols-4 gap-x-6 gap-y-12 md:grid-cols-6 md:gap-y-24">
				...
				<div class="col-span-3 col-start-2 md:col-start-4">
					<p class="subheading mb-8">Уроки предназначены для всех возрастов и всех уровней .</p>
					<p class="text-xl md:text-2xl mb-2">Занятия проволятся во всех основных скейт-парках и локация Дубая:</p>
					<ul class="italic text-xl md:text-2xl mb-8">
						<li>Dubai Skatepark</li>
						<li>XDubai</li>
						<li>The Block Dubai</li>
						<li>Dubai Hills Park</li>
						<li>Olympic-sized tracks (Nad Al Sheba)</li>
						<li>...</li>
					</ul>
					<p class="text-xl md:text-2xl bold"><strong>Скидки доступны для большего количества участников , более длительных занятий или при составлении пакета .</strong></p>
				</div>
				<!-- Cards -->
